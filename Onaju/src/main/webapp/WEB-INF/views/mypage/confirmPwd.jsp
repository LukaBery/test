...
<body>
	...
	<span class="inputWrap_order"> <input type="text" name="u_id"
				...
				<span class="hb_order_a"> 현재 비밀번호를 입력해주세요.

				</span> 
							 <a class="hb_order_submit" style="background-color:white; color:rgb(252, 96, 143);"  href="javascript:fn_delete_member();">비밀번호 확인</a>
				<a class="hb_order_submit"  style="background-color: rgb(252, 96, 143); color: white;" href="${contextPath}/main/main.do">홈페이지 이동</a>
