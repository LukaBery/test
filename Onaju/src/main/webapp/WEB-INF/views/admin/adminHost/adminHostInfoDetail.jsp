	...
	<section class="memDetail_con">
		...
		<div class="mem-item2">
			...
			<div class="mem-item2-chil">
				...
				<div class="mem-item2-chil-2"><div>${adminHostInfoVO.h_email1 }${adminHostInfoVO.h_email2 }</div></div>
				<div class="mem-item2-chil-1"><div>대표자전화번호</div></div>
				<div class="mem-item2-chil-2"><div>${adminHostInfoVO.h_phone } </div></div>
			</div>	
		</div>
